...
struct background
{
  ...
  double theta_ini_sfdm;     /**< Initial value of the SFDM angular variable */
  double y1_ini_sfdm;        /**< Initial value of \f$ y_1 = 2m_\phi/H \f$*/
  double alpha_ini_sfdm;     /**< Initial value of alpha_sfdm = 0.5*ln(Omega_sfdm) */
  ...
  /** SFDM**/
  int index_bg_theta_sfdm;   /**< SFDM angular variable \f$ \theta \f$ */
int index_bg_y1_sfdm;        /**< SFDM mass-to-Hubble variable \f$ y_1=2m_\phi/H \f$ */
int index_bg_e2alpha_sfdm;   /**< SFDM density fraction \f$ \Omega_\phi=e^{2\alpha} \f$ */
int index_bg_rho_sfdm;       /**< SFDM energy density */
int index_bg_p_sfdm;         /**< SFDM pressure */
  ...
  /** SFDM **/
  int index_bi_theta_sfdm; /**< {B} angular variable of the SFDM polar decomposition */
  int index_bi_y1_sfdm;    /**< {B} mass variable \f$ y_1 = 2m_\phi/H \f$ */
  int index_bi_alpha_sfdm; /**< {B} amplitude variable defined through \f$ \Omega_\phi=e^{2\alpha} \f$ */
