...
struct perturbations
{
  ...
  short has_source_delta_sfdm;  /**< do we need source for delta from scalar field dark matter? */
  ...
  short has_source_theta_sfdm;  /**< do we need source for theta of scalar field dark matter? */
  ...
  int index_tp_delta_sfdm;  /**< index value for delta of scalar field dark matter */ 
  int index_tp_delta0_sfdm;  /**< index value for delta auxiliary of scalar field dark matter */ 
  int index_tp_delta1_sfdm;  /**< index value for delta auxiliary of scalar field dark matter */ 
  ...
  int index_tp_theta_sfdm;  /**< index value for theta of scalar field dark matter */
...
struct perturbations_vector
{
  ...
  int index_pt_delta0_sfdm;  /**< scalar field dark matter auxiliary density */
  int index_pt_delta1_sfdm;  /**< scalar field dark matter auxiliary density  */
