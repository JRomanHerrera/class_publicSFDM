...
struct perturbations
{
  ...
  short has_source_delta_sfdm; /**< do we need source for SFDM density contrast? */
  ...
  short has_source_theta_sfdm; /**< do we need source for SFDM velocity divergence? */
  ...
  int index_tp_delta0_sfdm;  /**< SFDM perturbation variable delta_0  */ 
  int index_tp_delta1_sfdm;  /**< SFDM perturbation variable delta_1  */ 
...
struct perturbations_vector
{
  ...
  int index_pt_delta0_sfdm;  /**< SFDM perturbation variable delta_0 */
  int index_pt_delta1_sfdm;  /**< SFDM perturbation variable delta_1 */
